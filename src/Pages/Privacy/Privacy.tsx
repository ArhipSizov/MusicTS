    ...
    <div className="privacy">
      ...
      <div>
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые Сизов Архип
          Викторович (далее — Оператор).
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://music-5e477.web.app/.
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          Персональные данные - электронный адрес, номера телефонов, фотографии,
          имя
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          arhipsizov47@gmail.com с пометкой «Актуализация персональных данных».
        </p>
        <p>
          ...
          на электронный адрес Оператора arhipsizov47@gmail.com с пометкой
      ...
      <div>
        ...
        <p>
          ...
          Оператору с помощью электронной почты arhipsizov47@gmail.com.
        </p>
        <p>
        ...
        <p>
          ...
          сети Интернет по адресу https://music-5e477.web.app/privacy.
        </p>
      </div>
    </div>
  );
